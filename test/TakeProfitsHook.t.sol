...
// Our contracts
import {TakeProfitsHook} from "../src/TakeProfitHook.sol";

contract TakeProfitsHook is Test, Deployers {
    // Use the libraries
    ...
    function setUp() public {
        ...
        function test_placeOrder() public {
            ...
            // Check the balance of ERC1155 tokens we received
            uint256 positionId = hook.getPosition(key, tickLower, zeroForOne);
            uint256 tokenBalance = hook.balanceOf(address(this), positionId);

            // Ensure that we were, in fact, given ERC1155 tokens for the order
            // equal to the `amount` of token0 tokens we place the order for
        ...
        function test_cancelOrder() public {
            ...
            // Check the balances of ERC1155 tokens we received
            ...
            // Check that we received our token0 tokens back, and longer
            // own any ERC1155 tokens
